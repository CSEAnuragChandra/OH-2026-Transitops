...
// Minimal driver portal — shows the driver's currently assigned active trip
...
import { Truck, Route, MapPin, LogOut, Gauge } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg)" }}>
      ...
      <header className="flex items-center justify-between px-5 py-4 border-b"
        ...
        >
          <button type="submit" className="flex items-center gap-1.5 text-xs text-slate-400 hover:text-red-400">
            ...
            <div>
              ...
              <p className="text-xs mt-0.5">
                ...
                <span className="font-bold" style={{
                  color: (driverProfile?.safetyScore ?? 0) >= 90 ? "var(--success)" : "var(--warning)"
                }}>
                  {driverProfile?.safetyScore ?? "—"}/100
                </span>
              </p>
            </div>
          </CardContent>
